...
function FeaturedProjects() {
  const projects = [
    {
      title: "Gene Expression Analysis & Biomarker Discovery",
      description:
        "Bioinformatics project analyzing gene expression data using Python, Pandas, and statistical testing. Performed fold-change analysis, t-tests, multiple testing correction, and visualized results using bar charts and volcano plots to identify potential disease biomarkers.",
      image: bio17,
      tech: ["Python", "Pandas", "NumPy", "SciPy", "Matplotlib", "Statistical Analysis"],
      github: "https://github.com/Bharath-goda87/Bio-marker-project.git", 
      live: "#",   
    },
    {
      title: "Pharmacovigilance Safety Monitoring & Signal Detection (Python)",
      description: "Built a Python-based pharmacovigilance analytics workflow to perform case validation, duplicate detection, serious case signal analysis, and drug-event frequency visualization using structured adverse event datasets.",
      image: bio18,
      tech: ["Python", "Pandas", "Matplotlib", "Data cleaning", "Pharmacovigilance"],
      github: "https://github.com/Bharath-goda87/pharmacovigilance-adverse-event-.git", 
      live: "#",   
    },
  ];
  return (
    <section id="projects" className="bg-black text-white py-20 px-4">
      ...
      <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto" data-aos="zoom-in">
