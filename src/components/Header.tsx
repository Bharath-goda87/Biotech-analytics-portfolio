...
function Header() {
  ...
  return (
    <nav className="fixed top-0 w-full backdrop-blur-md border-b  border-white/10 z-50 w-full max-w-7xl mx-auto px-6" style={{
          backgroundImage:
            "url('https://img.freepik.com/premium-photo/technology-blue-wave-with-particles-big-data-visualization-analytics-representation-digital-dynamic-music-background-3d-rendering_105800-2998.jpg')",    
